 ...
 * helper daemon (`dsh-computer-daemon`, sources in this package's `native/`
...
import { COMPUTER_SETTINGS_NAMESPACE, ComputerEngine, normalizeDirection, normalizeMouseButton, truncateTreeChars, truncateTreeText } from 'dsh-computer'
import type {
  ClickRequest,
  ComputerApp,
  ComputerAppState,
