# @zibokapi/dsh-codex-computer-use/computer-tools
...
Deployment policy belongs in `tools/pre-execute`; [`@zibokapi/dsh-codex-computer-use/computer-policy`](computer-policy.md) supplies the approval gate for control actions.
